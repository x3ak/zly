 ...
 * @subpackage Plugins
 * @author     Danceric
 * @version    $Id: Doctrine.php 1237 2011-04-18 19:52:08Z deeper $
 */
    ...
    */
    public function __construct(array $options = array())
    {
        if(!isset($options['manager']) || !count($options['manager'])) {
            if (class_exists('Doctrine_Manager') && Doctrine_Manager::getInstance()) {
    ...
    */
    public function getTab()
    {
        ...
        foreach ($this->_profilers as $profiler) {
            ...
            $profilerInfo[] = 'Doctrine: '.$profiler->count() . ' in ' . round($time*1000, 2) . ' ms';
        }
