...
namespace Zly\Doctrine\Translatable\Entity\Repository;
 ...
 * @package Zly\Doctrine.Translatable.Entity.Repository
...
class TranslationRepository extends EntityRepository
{
    ...
    public function translate($entity, $field, $locale, $value)
    {
        ...
        if (!isset($config['fields']) || !in_array($field, $config['fields'])) {
            throw new \Zly\Doctrine\Exception\InvalidArgumentException("Entity: {$meta->name} does not translate - {$field}");
        }
