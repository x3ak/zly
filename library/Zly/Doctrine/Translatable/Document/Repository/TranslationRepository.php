...
namespace Zly\Doctrine\Translatable\Document\Repository;

use Zly\Doctrine\Translatable\TranslationListener;
use Doctrine\ODM\MongoDB\DocumentRepository;
use Doctrine\ODM\MongoDB\Cursor;
use Zly\Doctrine\Tool\Wrapper\MongoDocumentWrapper;
 ...
 * @package Zly\Doctrine.Translatable.Document.Repository
...
class TranslationRepository extends DocumentRepository
{
    ...
    public function translate($document, $field, $locale, $value)
    {
        ...
        if (!isset($config['fields']) || !in_array($field, $config['fields'])) {
            throw new \Zly\Doctrine\Exception\InvalidArgumentException("Document: {$meta->name} does not translate - {$field}");
        }
