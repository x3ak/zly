...
namespace Zly\Doctrine\Translatable\Mapping\Event\Adapter;
...
use Zly\Doctrine\Translatable\Mapping\Event\TranslatableAdapter;
 ...
 * @package Zly\Doctrine\Translatable\Mapping\Event\Adapter
 * @subpackage ODM
...
final class ODM extends BaseAdapterODM implements TranslatableAdapter
{
    ...
    {
        return 'Zly\Doctrine\\Translatable\\Document\\Translation';
    }
    ...
    public function insertTranslationRecord($translation)
    {
        ...
        if (!$collection->insert($data)) {
            throw new \Zly\Doctrine\Exception\RuntimeException('Failed to insert new Translation record');
        }
    }
