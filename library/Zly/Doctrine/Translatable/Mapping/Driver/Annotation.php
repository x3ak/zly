...
namespace Zly\Doctrine\Translatable\Mapping\Driver;
 ...
 * @package Zly\Doctrine.Translatable.Mapping.Driver
...
class Annotation implements AnnotationDriverInterface
{
     ...
     */
    const ENTITY_CLASS = 'Zly\Doctrine\\Mapping\\Annotation\\TranslationEntity';

    /**
     * Annotation to identify field as translatable
     */
    const TRANSLATABLE = 'Zly\Doctrine\\Mapping\\Annotation\\Translatable';

    /**
     * Annotation to identify field which can store used locale or language
     * alias is LANGUAGE
     */
    const LOCALE = 'Zly\Doctrine\\Mapping\\Annotation\\Locale';

    /**
     * Annotation to identify field which can store used locale or language
     * alias is LOCALE
     */
    const LANGUAGE = 'Zly\Doctrine\\Mapping\\Annotation\\Language';
