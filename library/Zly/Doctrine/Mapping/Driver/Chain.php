...
namespace Zly\Doctrine\Mapping\Driver;

use Zly\Doctrine\Mapping\Driver,
 ...
 * @package Zly\Doctrine.Mapping.Driver
 * @subpackage Chain
...
class Chain implements Driver
{
    ...
    public function readExtendedMetadata(ClassMetadata $meta, array &$config)
    {
        ...
        throw new \Zly\Doctrine\Exception\UnexpectedValueException('Class ' . $meta->name . ' is not a valid entity or mapped super class.');
    }
