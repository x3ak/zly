...
namespace Zly\Doctrine\Mapping;

use Doctrine\Common\Annotations\AnnotationReader;
use Doctrine\Common\Annotations\CachedReader;
use Doctrine\Common\Cache\ArrayCache;
use Doctrine\Common\Annotations\Reader;
use Zly\Doctrine\Mapping\ExtensionMetadataFactory;
...
abstract class MappedEventSubscriber implements EventSubscriber
{
     ...
     *
     * @var Zly\Doctrine\Mapping\ExtensionMetadataFactory
     */
     ...
     * @throws \Zly\Doctrine\Exception\InvalidArgumentException - if event is not recognized
     * @return \Zly\Doctrine\Mapping\Event\AdapterInterface
     */
        ...
        if (preg_match('@Doctrine\\\([^\\\]+)@', $class, $m) && in_array($m[1], array('ODM', 'ORM'))) {
            if (!isset($this->adapters[$m[1]])) {
                ...
                if (!class_exists($adapterClass)) {
                    $adapterClass = 'Zly\Doctrine\\Mapping\\Event\\Adapter\\'.$m[1];
                }
            ...
            throw new \Zly\Doctrine\Exception\InvalidArgumentException('Event mapper does not support event arg class: '.$class);
        }
    }
     ...
     *
     * @param ObjectManager $objectManager
     * @return Zly\Doctrine\Mapping\ExtensionMetadataFactory
     */
        ...
        if (null === $this->defaultAnnotationReader) {
            if (version_compare(\Doctrine\Common\Version::VERSION, '2.1.0RC4-DEV', '>=')) {
                ...
                \Doctrine\Common\Annotations\AnnotationRegistry::registerAutoloadNamespace(
                    'Zly\Doctrine\\Mapping\\Annotation',
                    __DIR__ . '/../../'
                );
                ...
                $reader->setAnnotationNamespaceAlias('Zly\Doctrine\\Mapping\\Annotation\\', 'Zly');
