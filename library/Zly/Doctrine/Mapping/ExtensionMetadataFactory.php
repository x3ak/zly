...
use Zly\Doctrine\Mapping\Driver\File as FileDriver;
...
final class ExtensionMetadataFactory
{
    /**
     * Extension driver
     * @var Zly\Doctrine\Mapping\Driver
     */
    private $driver;
     ...
     * @return Zly\Doctrine\Mapping\Driver
     */
    private function getDriver($omDriver)
    {
        ...
        if ($driverName == 'DriverChain') {
            ...
            if (!class_exists($driverClassName)) {
                ...
                if (!class_exists($driverClassName)) {
                    throw new \Zly\Doctrine\Exception\RuntimeException("Failed to fallback to annotation driver: ({$driverClassName}), extension driver was not found.");
                }
            }
