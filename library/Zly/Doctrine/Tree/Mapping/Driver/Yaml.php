...
namespace Zly\Doctrine\Tree\Mapping\Driver;

use Zly\Doctrine\Mapping\Driver\File,
    Zly\Doctrine\Mapping\Driver,
    Doctrine\Common\Persistence\Mapping\ClassMetadata,
    Zly\Doctrine\Exception\InvalidMappingException;
 ...
 * @package Zly\Doctrine.Tree.Mapping.Driver
 * @subpackage Yaml
...
class Yaml extends File implements Driver
{
    ...
    public function readExtendedMetadata(ClassMetadata $meta, array &$config)
    {
        ...
        if (isset($mapping['Zly\Doctrine'])) {
            $classMapping = $mapping['Zly\Doctrine'];
        ...
        if (isset($mapping['manyToOne'])) {
            foreach ($mapping['manyToOne'] as $field => $relationMapping) {
                if (isset($relationMapping['Zly\Doctrine'])) {
                    if (in_array('treeParent', $relationMapping['Zly\Doctrine'])) {
