...
use Zly\Doctrine\Mapping\Driver\AnnotationDriverInterface,
...
class Annotation implements AnnotationDriverInterface
{
     ...
     */
    const TREE = 'Zly\Doctrine\\Mapping\\Annotation\\Tree';

    /**
     * Annotation to mark field as one which will store left value
     */
    const LEFT = 'Zly\Doctrine\\Mapping\\Annotation\\TreeLeft';

    /**
     * Annotation to mark field as one which will store right value
     */
    const RIGHT = 'Zly\Doctrine\\Mapping\\Annotation\\TreeRight';

    /**
     * Annotation to mark relative parent field
     */
    const PARENT = 'Zly\Doctrine\\Mapping\\Annotation\\TreeParent';

    /**
     * Annotation to mark node level
     */
    const LEVEL = 'Zly\Doctrine\\Mapping\\Annotation\\TreeLevel';

    /**
     * Annotation to mark field as tree root
     */
    const ROOT = 'Zly\Doctrine\\Mapping\\Annotation\\TreeRoot';

    /**
     * Annotation to specify closure tree class
     */
    const CLOSURE = 'Zly\Doctrine\\Mapping\\Annotation\\TreeClosure';
