...
use Zly\Doctrine\Mapping\Driver\Xml as BaseXml,
...
class Xml extends BaseXml
{
    ...
    public function readExtendedMetadata(ClassMetadata $meta, array &$config) {
        ...
        $xmlDoctrine = $xml;
        $xml = $xml->children(self::ZLY_NAMESPACE_URI);
        ...
        if (isset($xmlDoctrine->field)) {
            foreach ($xmlDoctrine->field as $mapping) {
                ...
                $mapping = $mapping->children(self::ZLY_NAMESPACE_URI);
        ...
        if (isset($xmlDoctrine->{'many-to-one'})) {
            foreach ($xmlDoctrine->{'many-to-one'} as $manyToOneMapping)  {
                ...
                $manyToOneMapping = $manyToOneMapping->children(self::ZLY_NAMESPACE_URI);;
